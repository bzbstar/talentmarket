...
/**
 * 
 * @Description:带证书的post请求工具类
 * @author:bzb
 * @time:2018年11月17日 下午9:16:48
 */
@Component
public class HttpUtils {
	
	@Autowired
	private static String mchid = "1518781481";
	...
	static{
		Resource resource = new ClassPathResource("wxpay/apiclient_cert.p12");
		try {
